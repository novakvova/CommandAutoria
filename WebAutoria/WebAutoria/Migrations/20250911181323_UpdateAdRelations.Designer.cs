...
namespace WebAutoria.Migrations
{
    ...
    [Migration("20250911181323_UpdateAdRelations")]
    partial class UpdateAdRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarPhotoEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebAutoria.Data.Entities.Identity.UserRoleEntity", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("WebAutoria.Data.Entities.Identity.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("WebAutoria.Data.Entities.Identity.UserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebAutoria.Data.Entities.Identity.UserRoleEntity", b =>
                {
                    b.HasOne("WebAutoria.Data.Entities.Identity.RoleEntity", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
